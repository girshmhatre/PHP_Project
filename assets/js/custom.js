...
/*===================================*
09. QUICKVIEW POPUP + ZOOM assets/image + PRODUCT SLIDER JS
*===================================*/

$(window).on('load',function(){
	
	/*assets/image GALLERY POPUP*/
	$('.assets/image_popup').on('click', function () {
			$(this).find('.link_container').magnificPopup('open');
		});
		$('.link_container').each(function () {
		$(this).magnificPopup({
			delegate: '.assets/image_popup',
			type: 'assets/image',
			gallery: {
				enabled: true
			}
	...
	if(zoomActive) {
		...
		$.removeData(assets/image, 'elevateZoom');//remove zoom instance from assets/image
	...
	$('.quickview-popup-link').magnificPopup({
		...
		callbacks: {
			open: function() {
				$('body').addClass('zoom_assets/image');
			...
			close: function() {
				...
				setTimeout(function() {
					$('body').removeClass('zoom_assets/image');
...
*===================================*/
	...
	function init() {
		...
		var marker = new google.maps.Marker({
			...
			map: map,
			icon: "assets/image/map-location.png",
			title: 'Snazzy!'
		});
	}	
...
*===================================*/
	...
	$(document).ready(function() {
		$('.popup-gallery').magnificPopup({
			delegate: 'a',
			type: 'assets/image',
			tLoading: 'Loading assets/image #%curr%...',
			...
			assets/image: {
				tError: '<a href="%url%">The assets/image #%curr%</a> could not be loaded.',
			}
		});
	});
...
$( window ).on( "load", function() {
	...
	if( $grid_selectors.length > 0 ) {
		$grid_selectors.assets/imagesLoaded(function(){
...
$('.grid_item .assets/image_popup').on('click', function () {
	$(this).find('.link_container').magnificPopup('open');
});
$('.link_container').each(function () {
	$(this).magnificPopup({
